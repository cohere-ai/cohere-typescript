...
export class Models {
    ...
    private async __get(
        ...
        if (_response.ok) {
            return { data: _response.body as Cohere.GetModelResponse, rawResponse: _response.rawResponse };
        }
    ...
    private async __list(
        ...
        const { page_size: pageSize, page_token: pageToken, endpoint, default_only: defaultOnly } = request;
        ...
        if (_response.ok) {
            return { data: _response.body as Cohere.ListModelsResponse, rawResponse: _response.rawResponse };
        }
