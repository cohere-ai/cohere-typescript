...
export declare namespace TranscriptionsClient {
...
export class TranscriptionsClient {
    protected readonly _options: NormalizedClientOptionsWithAuth<TranscriptionsClient.Options>;

    constructor(options: TranscriptionsClient.Options = {}) {
     ...
     * @param {Cohere.audio.TranscriptionsCreateRequest} request
    ...
    ): core.HttpResponsePromise<Cohere.audio.AudioTranscriptionsCreateResponse> {
        return core.HttpResponsePromise.fromPromise(this.__create(file, request, requestOptions));
    }
    ...
    private async __create(
        ...
        request: Cohere.audio.TranscriptionsCreateRequest,
        requestOptions?: TranscriptionsClient.RequestOptions,
    ): Promise<core.WithRawResponse<Cohere.audio.AudioTranscriptionsCreateResponse>> {
        ...
        if (_response.ok) {
            return {
                data: serializers.audio.AudioTranscriptionsCreateResponse.parseOrThrow(_response.body, {
        ...
        return handleNonStatusCodeError(_response.error, _response.rawResponse, "POST", "/v2/audio/transcriptions");
    }
}
