...
export class V2Client {
    ...
    private async __embed(
        ...
        return handleNonStatusCodeError(_response.error, _response.rawResponse, "POST", "/v2/embed");
    }
    ...
    private async __rerank(
        ...
        return handleNonStatusCodeError(_response.error, _response.rawResponse, "POST", "/v2/rerank");
    }
}
