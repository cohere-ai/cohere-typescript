...
export class V2 {
    ...
    ): core.HttpResponsePromise<core.Stream<Cohere.StreamedChatResponseV2>> {
    ...
    private async __chatStream(
        request: Cohere.V2ChatStreamRequest,
        requestOptions?: V2.RequestOptions,
    ): Promise<core.WithRawResponse<core.Stream<Cohere.StreamedChatResponseV2>>> {
    ...
    public chat(
        ...
        requestOptions?: V2.RequestOptions,
    ): core.HttpResponsePromise<Cohere.ChatResponse> {
    ...
    private async __chat(
        request: Cohere.V2ChatRequest,
        requestOptions?: V2.RequestOptions,
    ): Promise<core.WithRawResponse<Cohere.ChatResponse>> {
        ...
        if (_response.ok) {
            return { data: _response.body as Cohere.ChatResponse, rawResponse: _response.rawResponse };
        }
    ...
    private async __embed(
        ...
        if (_response.ok) {
            return { data: _response.body as Cohere.EmbedByTypeResponse, rawResponse: _response.rawResponse };
        }
    ...
    private async __rerank(
        ...
        if (_response.ok) {
            return { data: _response.body as Cohere.V2RerankResponse, rawResponse: _response.rawResponse };
        }
