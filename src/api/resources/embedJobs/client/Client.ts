...
export declare namespace EmbedJobsClient {
    export type Options = BaseClientOptions;

    export interface RequestOptions extends BaseRequestOptions {}
}

export class EmbedJobsClient {
    protected readonly _options: NormalizedClientOptionsWithAuth<EmbedJobsClient.Options>;

    constructor(options: EmbedJobsClient.Options = {}) {
     ...
     *
     * @param {EmbedJobsClient.RequestOptions} requestOptions - Request-specific configuration.
     *
    ...
    ): core.HttpResponsePromise<Cohere.ListEmbedJobResponse> {
    ...
    private async __list(
        ...
        return handleNonStatusCodeError(_response.error, _response.rawResponse, "GET", "/v1/embed-jobs");
    }
    ...
    private async __create(
        ...
        return handleNonStatusCodeError(_response.error, _response.rawResponse, "POST", "/v1/embed-jobs");
    }
     ...
     */
    public get(id: string, requestOptions?: EmbedJobsClient.RequestOptions): core.HttpResponsePromise<Cohere.EmbedJob> {
    ...
    private async __get(
        ...
        return handleNonStatusCodeError(_response.error, _response.rawResponse, "GET", "/v1/embed-jobs/{id}");
    }
     ...
     */
    public cancel(id: string, requestOptions?: EmbedJobsClient.RequestOptions): core.HttpResponsePromise<void> {
    ...
    private async __cancel(
        ...
        return handleNonStatusCodeError(_response.error, _response.rawResponse, "POST", "/v1/embed-jobs/{id}/cancel");
    }
}
