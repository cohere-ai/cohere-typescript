...
export class BedrockClient extends CohereClient {
    constructor(protected readonly _options: CohereClient.Options & BedrockProps) {
        _options.token = "n/a";
        super(_options);
        this.overrideFetch();
    }
    ...
    async getAuthHeaders(url: URL, req: RequestInit, props: BedrockProps): Promise<Record<string, string>> {
