...
import { AudioClient } from "./api/resources/audio/client/Client";
import { BatchesClient } from "./api/resources/batches/client/Client";
import { ConnectorsClient } from "./api/resources/connectors/client/Client";
import { DatasetsClient } from "./api/resources/datasets/client/Client";
import { EmbedJobsClient } from "./api/resources/embedJobs/client/Client";
import { FinetuningClient } from "./api/resources/finetuning/client/Client";
...
export class CohereClient {
    protected readonly _options: NormalizedClientOptionsWithAuth<CohereClient.Options>;
    protected _v2: V2Client | undefined;
    protected _batches: BatchesClient | undefined;
    protected _embedJobs: EmbedJobsClient | undefined;
    ...
    public get embedJobs(): EmbedJobsClient {
        return (this._embedJobs ??= new EmbedJobsClient(this._options));
    }
    ...
    private async __generateStream(
        ...
        return handleNonStatusCodeError(_response.error, _response.rawResponse, "POST", "/v1/generate");
    }
    ...
    private async __embed(
        ...
        return handleNonStatusCodeError(_response.error, _response.rawResponse, "POST", "/v1/embed");
    }
    ...
    private async __rerank(
        ...
        return handleNonStatusCodeError(_response.error, _response.rawResponse, "POST", "/v1/rerank");
    }
    ...
    private async __classify(
        ...
        return handleNonStatusCodeError(_response.error, _response.rawResponse, "POST", "/v1/classify");
    }
    ...
    private async __summarize(
        ...
        return handleNonStatusCodeError(_response.error, _response.rawResponse, "POST", "/v1/summarize");
    }
    ...
    private async __tokenize(
        ...
        return handleNonStatusCodeError(_response.error, _response.rawResponse, "POST", "/v1/tokenize");
    }
    ...
    private async __detokenize(
        ...
        return handleNonStatusCodeError(_response.error, _response.rawResponse, "POST", "/v1/detokenize");
    }
    ...
    private async __checkApiKey(
        ...
        return handleNonStatusCodeError(_response.error, _response.rawResponse, "POST", "/v1/check-api-key");
    }
