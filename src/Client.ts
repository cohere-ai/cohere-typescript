...
import * as Cohere from "./api/index.js";
import urlJoin from "url-join";
import * as stream from "stream";
import * as errors from "./errors/index.js";
import { V2 } from "./api/resources/v2/client/Client.js";
import { EmbedJobs } from "./api/resources/embedJobs/client/Client.js";
import { Datasets } from "./api/resources/datasets/client/Client.js";
import { Connectors } from "./api/resources/connectors/client/Client.js";
import { Models } from "./api/resources/models/client/Client.js";
import { Finetuning } from "./api/resources/finetuning/client/Client.js";
...
export class CohereClient {
    ...
    private async __chatStream(
        ...
        const { Accepts: accepts, ..._body } = request;
    ...
    private async __chat(
        ...
        if (_response.ok) {
            return { data: _response.body as Cohere.NonStreamedChatResponse, rawResponse: _response.rawResponse };
        }
    ...
    private async __generate(
        ...
        if (_response.ok) {
            return { data: _response.body as Cohere.Generation, rawResponse: _response.rawResponse };
        }
    ...
    private async __embed(
        ...
        if (_response.ok) {
            return { data: _response.body as Cohere.EmbedResponse, rawResponse: _response.rawResponse };
        }
    ...
    private async __rerank(
        ...
        if (_response.ok) {
            return { data: _response.body as Cohere.RerankResponse, rawResponse: _response.rawResponse };
        }
    ...
    private async __classify(
        ...
        if (_response.ok) {
            return { data: _response.body as Cohere.ClassifyResponse, rawResponse: _response.rawResponse };
        }
    ...
    private async __summarize(
        ...
        if (_response.ok) {
            return { data: _response.body as Cohere.SummarizeResponse, rawResponse: _response.rawResponse };
        }
    ...
    private async __tokenize(
        ...
        if (_response.ok) {
            return { data: _response.body as Cohere.TokenizeResponse, rawResponse: _response.rawResponse };
        }
    ...
    private async __detokenize(
        ...
        if (_response.ok) {
            return { data: _response.body as Cohere.DetokenizeResponse, rawResponse: _response.rawResponse };
        }
    ...
    private async __checkApiKey(
        ...
        if (_response.ok) {
            return { data: _response.body as Cohere.CheckApiKeyResponse, rawResponse: _response.rawResponse };
        }
