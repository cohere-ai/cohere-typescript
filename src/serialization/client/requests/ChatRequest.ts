...
import { ChatRequestToolResultsItem } from "../../types/ChatRequestToolResultsItem";
...
export const ChatRequest: core.serialization.Schema<serializers.ChatRequest.Raw, Cohere.ChatRequest> =
    core.serialization.object({
        ...
        toolResults: core.serialization.property(
            "tool_results",
            core.serialization.list(ChatRequestToolResultsItem).optional()
        ),
    });
...
export declare namespace ChatRequest {
    interface Raw {
        ...
        tools?: Tool.Raw[] | null;
        tool_results?: ChatRequestToolResultsItem.Raw[] | null;
    }
}
