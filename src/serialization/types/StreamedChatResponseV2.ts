...
export declare namespace StreamedChatResponseV2 {
    type Raw =
        | StreamedChatResponseV2.MessageStart
        | StreamedChatResponseV2.ContentStart
        | StreamedChatResponseV2.ContentDelta
        | StreamedChatResponseV2.ContentEnd
        | StreamedChatResponseV2.ToolPlanDelta
        | StreamedChatResponseV2.ToolCallStart
        | StreamedChatResponseV2.ToolCallDelta
